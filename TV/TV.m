...
titre = title(sprintf('Flux énergétique primaire %1.1f MW',P_prim_en/1e3));
...
label_ex = {sprintf('Puissance effective \n %1.1f MW ',data_ex(1)/1e3)...
         ...
         sprintf('Irréversibilités à la turbine et aux pompes \n %1.1f MW ',data_ex(3)/1e3)...
         sprintf('Pertes au condenseur \n %1.1f MW ',data_ex(4)/1e3)...
         sprintf('Irréversibilités du transfert de chaleur au générateur de vapeur \n %1.1f MW ',data_ex(5)/1e3)...
...
titre = title(sprintf('Flux énergétique primaire %1.1f MW',P_prim_ex/1e3));
pos = get(titre,'position');
set(titre,'position',pos+[0 0.08 0]);
